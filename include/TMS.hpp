...
private:
    ...
    CO_OBJ_T objectDictionary[OBJECT_DICTIONARY_SIZE + 1] = {
        ...
        TRANSMIT_PDO_MAPPING_START_KEY_1AXX(2, 2),
        ...
        DATA_LINK_21XX(0, 1, CO_TSIGNED16, &sensorTemps[0]),
        DATA_LINK_21XX(0, 2, CO_TSIGNED16, &sensorTemps[1]),
        DATA_LINK_21XX(0, 3, CO_TSIGNED16, &sensorTemps[2]),
        DATA_LINK_21XX(0, 4, CO_TSIGNED16, &sensorTemps[3]),

        DATA_LINK_START_KEY_21XX(1, 4),
        DATA_LINK_21XX(1, 1, CO_TSIGNED16, &sensorTemps[4]),
        DATA_LINK_21XX(1, 2, CO_TSIGNED16, &sensorTemps[0]),
        DATA_LINK_21XX(1, 3, CO_TSIGNED16, &sensorTemps[0]),
        DATA_LINK_21XX(1, 4, CO_TSIGNED16, &sensorTemps[0]),

        DATA_LINK_START_KEY_21XX(2, 2),
        DATA_LINK_21XX(2, 1, CO_TUNSIGNED16, &flowRate[0]),
        DATA_LINK_21XX(2, 2, CO_TUNSIGNED16, &flowRate[1]),

        // Pump Command at 0x2200, 0
